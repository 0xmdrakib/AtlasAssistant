...
const DICT: Dict = {
  en: {
    ...
    savedTitle: "Saved",
    savedSubtitle: "Your reading collection, all in one place.",
    savedSave: "Save this post",
    savedRemove: "Remove from saved",
    savedAdded: "Post saved to your collection.",
    savedRemoved: "Removed from saved. Your slot is available again.",
    savedRetention: "Saved posts stay here while the original content is on Atlas. When a post leaves the platform, it also leaves your saved collection.",
    savedUsed: "saved posts",
    savedFreePlan: "Free plan",
    savedSlotHint: "Removing a save or an original post automatically frees a slot.",
    savedPlanHint: "Keep up to 10 posts on Free or 50 on Pro. Your collection is private and available on any device when you sign in.",
    savedLimitReached: "Your saved collection is full. Remove a saved post to make room for another.",
    savedDowngrade: "Your plan now allows 10 saves. Your existing saves are safe; bring your collection below 10 to add more, or upgrade to Pro.",
    savedUpgrade: "Get 50 saved posts with Pro",
    savedEmpty: "Keep something worth coming back to",
    savedEmptyHint: "Tap the bookmark on any post. You’ll find your saved stories here, newest saves first.",
    savedBrowse: "Browse the feed",
    savedLoading: "Loading your saved posts…",
    savedSignIn: "Sign in to save posts",
    savedLoadError: "We couldn’t refresh your saved posts. Please try again.",
    savedActionError: "We couldn’t update your saved posts. Please check your connection and try again.",
    savedItemGone: "This post is no longer on Atlas and can’t be saved.",
    savedRetry: "Try again",
    savedDismiss: "Dismiss notification",
    savedNewest: "Most recently saved",
    savedOn: "Saved",
  ...
  bn: {
    ...
    savedTitle: "সেভ করা পোস্ট",
    savedSubtitle: "পরে পড়ার জন্য রাখা পোস্ট, এক জায়গায়।",
    savedSave: "পোস্টটি সেভ করুন",
    savedRemove: "সেভ থেকে সরান",
    savedAdded: "পোস্টটি আপনার সংগ্রহে সেভ হয়েছে।",
    savedRemoved: "সেভ থেকে সরানো হয়েছে। জায়গাটি আবার খালি হয়েছে।",
    savedRetention: "মূল পোস্ট অ্যাটলাসে থাকা পর্যন্ত এখানে সেভ থাকবে। প্ল্যাটফর্ম থেকে পোস্ট মুছে গেলে আপনার সেভ থেকেও স্বয়ংক্রিয়ভাবে মুছে যাবে।",
    savedUsed: "পোস্ট সেভ করা আছে",
    savedFreePlan: "ফ্রি প্ল্যান",
    savedSlotHint: "সেভ সরালে বা মূল পোস্ট মুছে গেলে নতুন পোস্ট সেভ করার জায়গা খালি হবে।",
    savedPlanHint: "ফ্রি প্ল্যানে ১০টি, Pro প্ল্যানে ৫০টি পোস্ট সেভ রাখুন। আপনার সংগ্রহ ব্যক্তিগত; লগইন করে যেকোনো ডিভাইস থেকে দেখতে পারবেন।",
    savedLimitReached: "সেভের সীমা পূর্ণ হয়েছে। নতুন পোস্ট রাখতে আগের একটি সেভ সরান।",
    savedDowngrade: "বর্তমান প্ল্যানে ১০টি পোস্ট সেভ রাখা যায়। আগের সেভগুলো থাকবে; নতুন পোস্ট রাখতে সংখ্যা ১০-এর নিচে আনুন অথবা Pro নিন।",
    savedUpgrade: "Pro-তে ৫০টি পোস্ট সেভ রাখুন",
    savedEmpty: "পরে পড়তে চান এমন কিছু সেভ করুন",
    savedEmptyHint: "যেকোনো পোস্টের বুকমার্ক আইকনে চাপুন। সেভ করা পোস্টগুলো এখানে পাবেন, নতুন সেভ সবার আগে।",
    savedBrowse: "ফিড দেখুন",
    savedLoading: "সেভ করা পোস্ট লোড হচ্ছে…",
    savedSignIn: "পোস্ট সেভ করতে লগইন করুন",
    savedLoadError: "সেভ করা পোস্ট রিফ্রেশ করা যায়নি। আবার চেষ্টা করুন।",
    savedActionError: "সেভ আপডেট করা যায়নি। ইন্টারনেট সংযোগ দেখে আবার চেষ্টা করুন।",
    savedItemGone: "পোস্টটি আর অ্যাটলাসে নেই, তাই সেভ করা যাবে না।",
    savedRetry: "আবার চেষ্টা করুন",
    savedDismiss: "নোটিফিকেশন বন্ধ করুন",
    savedNewest: "সর্বশেষ সেভ করা পোস্ট",
    savedOn: "সেভ হয়েছে",
